...
from Citylink.Article1.Article2 import swprogram,posWordScraper,negWordScraper,neutralWord,calculate,posWordGraph,negWordGraph,posNegWordGraph,wordCountGraph
...
def article2():
    ...
    try:
        ...
        URL = "https://www.nst.com.my/news/crime-courts/2018/04/358091/ex-parcel-delivery-worker-gets-8-months-jail-stealing-parcels"
