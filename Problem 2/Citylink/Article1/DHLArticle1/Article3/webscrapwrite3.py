...
from Citylink.Article1.DHLArticle1.Article3 import swprogram,posWordScraper,negWordScraper,neutralWord,calculate,posWordGraph,negWordGraph,posNegWordGraph,wordCountGraph
#5 (a)
...
def article3():
    ...
    try:
        ...
        savePath = 'Problem 2\Citylink\Article1\DHLArticle1\Article3'
