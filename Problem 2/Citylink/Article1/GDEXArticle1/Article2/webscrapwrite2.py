...
import re
import os
from Citylink.Article1.GDEXArticle1.Article2 import swprogram,posWordScraper,negWordScraper,neutralWord,calculate,posWordGraph,negWordGraph,posNegWordGraph,wordCountGraph
...
def article2():
    try:
        ...
        savePath = 'Problem 2\Citylink\Article1\GDEXArticle1\Article2'
