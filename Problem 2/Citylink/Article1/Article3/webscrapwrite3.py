...
from Citylink.Article1.Article3 import swprogram,posWordScraper,negWordScraper,neutralWord,calculate,posWordGraph,negWordGraph,posNegWordGraph,wordCountGraph
...
#5 (a)
    try:
        ...
        URL = "https://isuzu.net.my/home/news-sub.php?id=126"
        driver = webdriver.Chrome(PATH)
        savePath = 'Problem 2\Citylink\Article1\Article3'
        ...
        article = page_soup.find('div', attrs={'class': 'col s12 m9 l9 mt55 mb2 pds44'})
