...
import re
import os
from DHLArticle1 import swprogram,posWordScraper,negWordScraper,neutralWord,calculate,posWordGraph,negWordGraph,posNegWordGraph,wordCountGraph
from DHLArticle1.Article3 import webscrapwrite3
from DHLArticle1.Article2 import webscrapwrite2
...
def dhl():
    ...
    try:
        ...
        savePath = 'Problem 2\Citylink\Article 1\DHLArticle1'
